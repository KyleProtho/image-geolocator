...
- [x] Add popular search keywords ("find location from picture", "where is this", etc.)
- [x] Create SEO-optimized landing page (`/how-it-works`)
- [x] Implement structured data (JSON-LD Schema.org markup)
...
- [x] Optimize meta descriptions and Open Graph tags
